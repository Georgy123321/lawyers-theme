...
$args = array(
	...
	'menu_title'                => esc_html__( 'Global Options', 'lawyers' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Global Options', 'lawyers' ),
...
$args['admin_bar_links'][] = array(
	'id'    => 'redux-docs',
	'href'  => '//devs.redux.io/',
	'title' => __( 'Documentation', 'lawyers' ),
);

$args['admin_bar_links'][] = array(
	'id'    => 'redux-support',
	'href'  => '//github.com/ReduxFramework/redux-framework/issues',
	'title' => __( 'Support', 'lawyers' ),
);
...
if ( ! isset( $args['global_variable'] ) || false !== $args['global_variable'] ) {
	...
	$args['intro_text'] = '<p>' . sprintf( esc_html__( 'Did you know that Redux sets a global variable for you? To access any of your saved options from within your code you can use your global variable: $%1$s', 'lawyers' ), '<strong>' . $v . '</strong>' ) . '<p>';
} else {
	$args['intro_text'] = '<p>' . esc_html__( 'This text is displayed above the options panel. It isn\'t required, but more info is always better! The intro_text field accepts all HTML.', 'lawyers' ) . '</p>';
}

// Add content after the form.
$args['footer_text'] = '<p>' . esc_html__( 'This text is displayed below the options panel. It isn\'t required, but more info is always better! The footer_text field accepts all HTML.', 'lawyers' ) . '</p>';
...
$help_tabs = array(
	array(
		'id'      => 'redux-help-tab-1',
		'title'   => esc_html__( 'Theme Information 1', 'lawyers' ),
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'lawyers' ) . '</p>',
	),
	array(
		'id'      => 'redux-help-tab-2',
		'title'   => esc_html__( 'Theme Information 2', 'lawyers' ),
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'lawyers' ) . '</p>',
	),
);
...
$content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', 'lawyers' ) . '</p>';
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Header', 'lawyers' ),
		'id'               => 'header',
		'desc'             => esc_html__( 'Header Fields', 'lawyers' ),
		...
		'fields'           => array(
			array(
				'id'       => 'Header-Phone',
				'type'     => 'text',
				'title'    => esc_html__( 'Phone', 'lawyers' ),
			),
			array(
				'id'       => 'Header-Mail',
				'type'     => 'text',
				'title'    => esc_html__( 'Mail', 'lawyers' ),
			),
			array(
				'id'       => 'Header-Button',
				'type'     => 'text',
				'title'    => esc_html__( 'Button', 'lawyers' ),
			),
			array(
				'id'       => 'Header-Logo',
				'type'     => 'media',
				'url'     => true,
				'title'    => esc_html__( 'Header Logo', 'lawyers' ),
				'desc'     => esc_html__( 'Upload Logo', 'lawyers' ),
			),
		),
	)
);
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Footer', 'lawyers' ),
		'id'               => 'footer',
		'desc'             => esc_html__( 'Footer Fields', 'lawyers' ),
		'customizer_width' => '400px',
		'icon'             => 'el el-home',
		'fields'           => array(
			array(
				...
				'type'     => 'media',
				'url'     => true,
				'title'    => esc_html__( 'Footer Logo', 'lawyers' ),
				'desc'     => esc_html__( 'Upload Logo', 'lawyers' ),
			),
			array(
				'id'       => 'footer-desck',
				'type'     => 'text',
				'title'    => esc_html__( 'Description', 'lawyers' ),
			),
			array(
				'id'       => 'footer-addres',
				'type'     => 'text',
				'title'    => esc_html__( 'Addres', 'lawyers' ),
			),
			array(
				'id'       => 'footer-Phone',
				'type'     => 'text',
			...
			array(
				...
				'type'     => 'media',
				'url'     => true,
				'title'    => esc_html__( 'Avatar', 'lawyers' ),
				'desc'     => esc_html__( 'Upload Logo', 'lawyers' ),
			),
			array(
				'id'       => 'footer-name',
				'type'     => 'text',
				'title'    => esc_html__( 'Name', 'lawyers' ),
			),
			array(
				'id'       => 'footer-post',
				'type'     => 'text',
				'title'    => esc_html__( 'Job Title', 'lawyers' ),
			),
			array(
				'id'       => 'footer-user-desc',
				'type'     => 'text',
...
if ( ! function_exists( 'dynamic_section' ) ) {
	...
	function dynamic_section( array $sections ): array {
		$sections[] = array(
			'title'  => esc_html__( 'Section via hook', 'lawyers' ),
			'desc'   => '<p class="description">' . esc_html__( 'This is a section created by adding a filter to the sections array. Can be used by child themes to add/remove sections from the options.', 'lawyers' ) . '</p>',
...
if ( ! function_exists( 'change_defaults' ) ) {
	...
	function change_defaults( array $defaults ): array {
		$defaults['str_replace'] = esc_html__( 'Testing filter hook!', 'lawyers' );
